package com.swashtech.quickcare.config;
...
public class SwaggerConfig {
	...
	public Docket postsApi() {
		return new Docket(DocumentationType.SWAGGER_2).groupName("quickcare-api").apiInfo(apiInfo()).select()
	...
	private ApiInfo apiInfo() {
		...
		return new ApiInfoBuilder().title("Quick Care Service").description("Quick Care Service API's")
